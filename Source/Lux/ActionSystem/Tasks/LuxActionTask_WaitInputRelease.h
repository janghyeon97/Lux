...
#include "LuxActionTask_WaitInputRelease.generated.h"



/**
 * ULuxActionTask_WaitInputRelease Task를 위한 초기화 파라미터입니다.
 */
USTRUCT(BlueprintType)
struct FWaitInputReleaseParams : public FBaseLuxActionTaskParams
{
    GENERATED_BODY()
...
UCLASS()
class LUX_API ULuxActionTask_WaitInputRelease : public ULuxActionTask
{
    GENERATED_BODY()
...
public:
    ...
    static ULuxActionTask_WaitInputRelease* WaitInputRelease(ULuxAction* InOwningAction, FGameplayTag InTagToWaitFor);
...
protected:
    ...
    UFUNCTION()
    void OnInputRelease(const FGameplayTag& InputTag);
